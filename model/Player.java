...
public class Player {
    ...
    private int golsReaisTemporada; // gols antes dos eventos inflarem
    ...
    public int getGolsReaisTemporada()       { return golsReaisTemporada; }
    ...
    public void setGolsReaisTemporada(int v)         { this.golsReaisTemporada = v; }
}